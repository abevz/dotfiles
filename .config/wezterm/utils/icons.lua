...
M.Numbers = {
  ...
  -- NOTE : easier to read
  wez.nerdfonts.md_numeric_1_box_multiple,
  wez.nerdfonts.md_numeric_2_box_multiple,
  wez.nerdfonts.md_numeric_3_box_multiple,
  wez.nerdfonts.md_numeric_4_box_multiple,
  wez.nerdfonts.md_numeric_5_box_multiple,
  wez.nerdfonts.md_numeric_6_box_multiple,
  wez.nerdfonts.md_numeric_7_box_multiple,
  wez.nerdfonts.md_numeric_8_box_multiple,
  wez.nerdfonts.md_numeric_9_box_multiple,
  wez.nerdfonts.md_numeric_10_box_multiple,
  wez.nerdfonts.md_numeric_11_box_multiple,
  wez.nerdfonts.md_numeric_12_box_multiple,
}
